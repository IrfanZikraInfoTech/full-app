...
const Dashboard = () => {
  ...
  return (
    <div className="overflow-x-hidden min-h-screen py-10 text-neutral-300 antialiased selection:bg-cyan-300 selection:text-cyan-900">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex gap-4">
            <button
              ...
              className="w-full  text-white px-4 py-2 rounded bg-neutral-950 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))] transition duration-300"
            >
              Add Student
            </button>
            <button
